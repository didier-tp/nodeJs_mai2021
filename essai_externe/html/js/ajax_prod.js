...
function onSelectRow(evt){
  ...
  makeAjaxGetRequest("http://localhost:8282/produit-api/public/produit/"+codeOfSelectedProd,function(data){
...
function refreshAllDataInTable(){
	...
	makeAjaxGetRequest("http://localhost:8282/produit-api/public/produit",function(data){
